...
define("CLSRESTAPI_VER_IMAGE_PATHS_NAME", "image-paths");
define("CLSRESTAPI_VER_IMAGE_PATHS_API", "1.0");
define("CLSRESTAPI_VER_IMAGE_PATHS_DATA", "1.0");
